...
%T5katei1AV = type opaque
%__opaque_existential_type_0 = type { [24 x i8], %swift.type* }
%T5katei1PP = type { [24 x i8], %swift.type*, i8** }
...
@"symbolic ______p 5katei1PP" = linkonce_odr hidden constant <{ i8, i64, [2 x i8], i8 }> <{ i8 1, i64 ptrtoint (<{ i32, i64, i64, i32, i32, i64, %swift.protocol_requirement }>* @"$s5katei1PMp" to i64), [2 x i8] c"_p", i8 0 }>, section "__DATA,__swift5_typeref, regular, no_dead_strip", align 2
@"$s5katei1P_pMD" = linkonce_odr hidden global { i64, i32 } { i64 ptrtoint (<{ i8, i64, [2 x i8], i8 }>* @"symbolic ______p 5katei1PP" to i64), i32 -7 }, align 8
@"$s5katei1AVAA1PAAMc" = constant %swift.protocol_conformance_descriptor {
  i64 ptrtoint (<{ i32, i64, i64, i32, i32, i64, %swift.protocol_requirement }>* @"$s5katei1PMp" to i64),
  i64 ptrtoint (<{ i32, i64, i64, i64, i64, i32, i32 }>* @"$s5katei1AVMn" to i64),
  i64 ptrtoint ([2 x i8*]* @"$s5katei1AVAA1PAAWP" to i64),
  i32 0
}, section "__DATA,__const", align 4
@"$s5katei1AVAA1PAAWP" = constant [2 x i8*] [i8* bitcast (%swift.protocol_conformance_descriptor* @"$s5katei1AVAA1PAAMc" to i8*), i8* bitcast (void (%T5katei1AV*, %swift.type*, i8**)* @"$s5katei1AVAA1PA2aDP3fooyyFTW" to i8*)], align 8
@"symbolic $s5katei1PP" = linkonce_odr hidden constant <{ [11 x i8], i8 }> <{ [11 x i8] c"$s5katei1PP", i8 0 }>, section "__DATA,__swift5_typeref, regular, no_dead_strip", align 2
@"$s5katei1P_pMF" = internal constant { i64, i32, i16, i16, i32 } { i64 ptrtoint (<{ [11 x i8], i8 }>* @"symbolic $s5katei1PP" to i64), i32 0, i16 4, i16 12, i32 0 }, section "__DATA,__swift5_fieldmd, regular, no_dead_strip", align 4
@0 = private constant [6 x i8] c"katei\00"
@"$s5kateiMXM" = linkonce_odr hidden constant <{ i32, i32, i64 }> <{
  i32 0, i32 0,
  i64 ptrtoint ([6 x i8]* @0 to i64)
}>, section "__DATA,__const", align 4
@1 = private constant [2 x i8] c"P\00"
@"$s5katei1PMp" = constant <{ i32, i64, i64, i32, i32, i64, %swift.protocol_requirement }> <{ i32 65603, i64 ptrtoint (<{ i32, i32, i64 }>* @"$s5kateiMXM" to i64), i64 ptrtoint ([2 x i8]* @1 to i64), i32 0, i32 1, i64 0, %swift.protocol_requirement { i32 17, i64 0 } }>, section "__DATA,__const", align 4
@"$sytWV" = external global i8*, align 8
@2 = private constant [2 x i8] c"A\00"
@"$s5katei1AVMn" = constant <{ i32, i64, i64, i64, i64, i32, i32 }> <{
  i32 81,
  i64 ptrtoint (<{ i32, i32, i64 }>* @"$s5kateiMXM" to i64),
  i64 ptrtoint ([2 x i8]* @2 to i64),
  i64 ptrtoint (%swift.metadata_response (i64)* @"$s5katei1AVMa" to i64),
  i64 ptrtoint ({ i64, i32, i16, i16, i32 }* @"$s5katei1AVMF" to i64),
  i32 0, i32 2
}>, section "__DATA,__const", align 4
@"$s5katei1AVMf" = internal constant <{ i8**, i64, <{ i32, i64, i64, i64, i64, i32, i32 }>* }> <{ i8** @"$sytWV", i64 512, <{ i32, i64, i64, i64, i64, i32, i32 }>* @"$s5katei1AVMn" }>, align 8
@"symbolic _____ 5katei1AV" = linkonce_odr hidden constant <{ i8, i64, i8 }> <{ i8 1, i64 ptrtoint (<{ i32, i64, i64, i64, i64, i32, i32 }>* @"$s5katei1AVMn" to i64), i8 0 }>, section "__DATA,__swift5_typeref, regular, no_dead_strip", align 2
@"$s5katei1AVMF" = internal constant { i64, i32, i16, i16, i32 } { i64 ptrtoint (<{ i8, i64, i8 }>* @"symbolic _____ 5katei1AV" to i64), i32 0, i16 0, i16 12, i32 0 }, section "__DATA,__swift5_fieldmd, regular, no_dead_strip", align 4
...
@"\01l_protocols" = private constant [1 x %swift.protocolref] [%swift.protocolref { i64 ptrtoint (<{ i32, i64, i64, i32, i32, i64, %swift.protocol_requirement }>* @"$s5katei1PMp" to i64) }], section "__DATA, __swift5_protos, regular, no_dead_strip", align 4
@"\01l_protocol_conformances" = private constant [1 x i64] [i64 ptrtoint (%swift.protocol_conformance_descriptor* @"$s5katei1AVAA1PAAMc" to i64)], section "__DATA, __swift5_proto, regular, no_dead_strip", align 4
@"\01l_type_metadata_table" = private constant [1 x %swift.type_metadata_record] [%swift.type_metadata_record { i64 ptrtoint (<{ i32, i64, i64, i64, i64, i32, i32 }>* @"$s5katei1AVMn" to i64) }], section "__DATA, __swift5_types, regular, no_dead_strip", align 4
@__swift_reflection_version = linkonce_odr hidden constant i16 3
@llvm.used = appending global [19 x i8*] [i8* bitcast (void ()* @"$s5katei1AV3fooyyF" to i8*), i8* bitcast (void (%T5katei1PP*)* @"$s5katei7callFooyyAA1P_pF" to i8*), i8* bitcast (void (%Any*)* @"$s5katei14callFooFromAnyyyypF" to i8*), i8* bitcast ([2 x i8*]* @"$s5katei1AVAA1PAAWP" to i8*), i8* bitcast ({ i64, i32, i16, i16, i32 }* @"$s5katei1P_pMF" to i8*), i8* bitcast (%swift.protocol_requirement* @"$s5katei1PTL" to i8*), i8* bitcast (<{ i32, i64, i64, i32, i32, i64, %swift.protocol_requirement }>* @"$s5katei1PMp" to i8*), i8* bitcast (<{ i32, i64, i64, i32, i32, i64, %swift.protocol_requirement }>* @"$s5katei1PMp" to i8*), i8* bitcast (<{ i32, i64, i64, i64, i64, i32, i32 }>* @"$s5katei1AVMn" to i8*), i8* bitcast (%swift.metadata_response (i64)* @"$s5katei1AVMa" to i8*), i8* bitcast (%swift.type* @"$s5katei1AVN" to i8*), i8* bitcast ({ i64, i32, i16, i16, i32 }* @"$s5katei1AVMF" to i8*), i8* bitcast (void ()** @"_swift_FORCE_LOAD_$_swiftCompatibility50_$_katei" to i8*), i8* bitcast (void ()** @"_swift_FORCE_LOAD_$_swiftCompatibilityDynamicReplacements_$_katei" to i8*), i8* bitcast ([1 x %swift.protocolref]* @"\01l_protocols" to i8*), i8* bitcast (%swift.protocol_conformance_descriptor* @"$s5katei1AVAA1PAAMc" to i8*), i8* bitcast ([1 x i64]* @"\01l_protocol_conformances" to i8*), i8* bitcast ([1 x %swift.type_metadata_record]* @"\01l_type_metadata_table" to i8*), i8* bitcast (i16* @__swift_reflection_version to i8*)], section "llvm.metadata", align 8

@"$s5katei1PTL" = alias %swift.protocol_requirement, getelementptr (%swift.protocol_requirement, %swift.protocol_requirement* getelementptr inbounds (<{ i32, i64, i64, i32, i32, i64, %swift.protocol_requirement }>, <{ i32, i64, i64, i32, i32, i64, %swift.protocol_requirement }>* @"$s5katei1PMp", i32 0, i32 6), i32 -1)
@"$s5katei1AVN" = alias %swift.type, bitcast (i64* getelementptr inbounds (<{ i8**, i64, <{ i32, i64, i64, i64, i64, i32, i32 }>* }>, <{ i8**, i64, <{ i32, i64, i64, i64, i64, i32, i32 }>* }>* @"$s5katei1AVMf", i32 0, i32 1) to %swift.type*)
...
entry:
  ...
  call swiftcc void @"$s5katei1AVACycfC"()
  %5 = getelementptr inbounds %Any, %Any* %2, i32 0, i32 1
  store %swift.type* bitcast (i64* getelementptr inbounds (<{ i8**, i64, <{ i32, i64, i64, i64, i64, i32, i32 }>* }>, <{ i8**, i64, <{ i32, i64, i64, i64, i64, i32, i32 }>* }>* @"$s5katei1AVMf", i32 0, i32 1) to %swift.type*), %swift.type** %5, align 8
  %6 = getelementptr inbounds %Any, %Any* %2, i32 0, i32 0
  %7 = getelementptr inbounds %Any, %Any* %2, i32 0, i32 0
  %8 = bitcast [24 x i8]* %7 to %T5katei1AV*
  call swiftcc void @"$s5katei14callFooFromAnyyyypF"(%Any* noalias nocapture dereferenceable(32) %2)
...
define swiftcc void @"$s5katei1AV3fooyyF"() #0 {
entry:
  ret void
}

define hidden swiftcc void @"$s5katei1AVACycfC"() #0 {
entry:
  ret void
}
...
define linkonce_odr hidden swiftcc void @"$s5katei1AVAA1PA2aDP3fooyyFTW"(%T5katei1AV* noalias nocapture swiftself, %swift.type* %Self, i8** %SelfWitnessTable) #0 {
entry:
  call swiftcc void @"$s5katei1AV3fooyyF"() #8
  ret void
}

define swiftcc void @"$s5katei7callFooyyAA1P_pF"(%T5katei1PP* noalias nocapture dereferenceable(40)) #0 {
entry:
  %1 = getelementptr inbounds %T5katei1PP, %T5katei1PP* %0, i32 0, i32 1
  %2 = load %swift.type*, %swift.type** %1, align 8
  %3 = getelementptr inbounds %T5katei1PP, %T5katei1PP* %0, i32 0, i32 2
  %4 = load i8**, i8*** %3, align 8
  %5 = bitcast %T5katei1PP* %0 to %__opaque_existential_type_1*
...
define swiftcc void @"$s5katei14callFooFromAnyyyypF"(%Any* noalias nocapture dereferenceable(32)) #0 {
entry:
  %1 = alloca %Any, align 8
  %2 = alloca %T5katei1PP, align 8
  %3 = bitcast %Any* %1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 32, i8* %3)
  %4 = call %Any* @"$sypWOc"(%Any* %0, %Any* %1)
  %5 = bitcast %T5katei1PP* %2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 40, i8* %5)
  %6 = bitcast %T5katei1PP* %2 to %swift.opaque*
  %7 = bitcast %Any* %1 to %swift.opaque*
  %8 = call %swift.type* @__swift_instantiateConcreteTypeFromMangledName({ i64, i32 }* @"$s5katei1P_pMD") #6
  ...
  call swiftcc void @"$s5katei7callFooyyAA1P_pF"(%T5katei1PP* noalias nocapture dereferenceable(40) %2)
  %10 = bitcast %T5katei1PP* %2 to %__opaque_existential_type_1*
  call void @__swift_destroy_boxed_opaque_existential_1(%__opaque_existential_type_1* %10) #4
  %11 = bitcast %T5katei1PP* %2 to i8*
...
; Function Attrs: noinline nounwind readnone
define swiftcc %swift.metadata_response @"$s5katei1AVMa"(i64) #7 {
entry:
  ret %swift.metadata_response { %swift.type* bitcast (i64* getelementptr inbounds (<{ i8**, i64, <{ i32, i64, i64, i64, i64, i32, i32 }>* }>, <{ i8**, i64, <{ i32, i64, i64, i64, i64, i32, i32 }>* }>* @"$s5katei1AVMf", i32 0, i32 1) to %swift.type*), i64 0 }
}
...
!1 = !{<{ i8, i64, [2 x i8], i8 }>* @"symbolic ______p 5katei1PP", null, null, i1 false, i1 true}
!2 = !{<{ [11 x i8], i8 }>* @"symbolic $s5katei1PP", null, null, i1 false, i1 true}
!3 = !{{ i64, i32, i16, i16, i32 }* @"$s5katei1P_pMF", null, null, i1 false, i1 true}
!4 = !{<{ i32, i32, i64 }>* @"$s5kateiMXM", null, null, i1 false, i1 true}
!5 = !{<{ i32, i64, i64, i32, i32, i64, %swift.protocol_requirement }>* @"$s5katei1PMp", null, null, i1 false, i1 true}
!6 = !{<{ i32, i64, i64, i64, i64, i32, i32 }>* @"$s5katei1AVMn", null, null, i1 false, i1 true}
!7 = !{<{ i8, i64, i8 }>* @"symbolic _____ 5katei1AV", null, null, i1 false, i1 true}
!8 = !{{ i64, i32, i16, i16, i32 }* @"$s5katei1AVMF", null, null, i1 false, i1 true}
!9 = !{[1 x %swift.protocolref]* @"\01l_protocols", null, null, i1 false, i1 true}
!10 = !{%swift.protocol_conformance_descriptor* @"$s5katei1AVAA1PAAMc", null, null, i1 false, i1 true}
