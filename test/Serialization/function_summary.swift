...
// RUN: %swift-module-summary-test --to-yaml %t/function_summary.swiftmodule.summary -o - | %FileCheck %s -check-prefix DIRECT-CALL
...
// RUN: %swift-module-summary-test --to-yaml %t/function_summary.swiftmodule.summary -o - | %FileCheck %s -check-prefix WITNESS-CALL
...
// RUN: %swift-module-summary-test --to-yaml %t/function_summary.swiftmodule.summary -o - | %FileCheck %s -check-prefix VTABLE-CALL
